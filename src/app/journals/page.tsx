...
export default function JournalsPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Submissions should default to { status: 'pending' } for admin approval
    const newEntry = {
    ...
    console.log("Submitting review (Pending Approval):", newEntry);
    
    // For local demo, let's just close modal. In real app, this would hit an API.
